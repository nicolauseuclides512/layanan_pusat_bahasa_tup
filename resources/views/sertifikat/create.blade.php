        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">{{ __('Tambah Sertifikat') }}</h5>
                </div>

                <div class="card-body">
                    <form action="{{ route('sertifikat.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('lembaga_penyelenggara') is-invalid @enderror" id="lembaga_penyelenggara" name="lembaga_penyelenggara" value="{{ old('lembaga_penyelenggara') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control @error('tanggal_ujian') is-invalid @enderror" id="tanggal_ujian" name="tanggal_ujian" value="{{ old('tanggal_ujian') }}" required>
                                @error('tanggal_ujian')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
